 ...
 * @version    $Id: Presenter.php 410 2009-07-13 18:58:40Z david@grudl.com $
 */
...
require_once __DIR__ . '/../Application/Control.php';

require_once __DIR__ . '/../Application/IPresenter.php';
...
abstract class Presenter extends Control implements IPresenter
{
	...
	{
		return (array) Nette\Annotations::get(new \ReflectionClass(get_called_class()), 'persistent');
	}
